...
<template>
  <div class="dark:bg-slate-900 dark:text-white transition-colors">
    ...
    <div class="font-inter">
      <section
        class="bg-gradient-to-br from-sky-50 to-white dark:from-slate-800 dark:to-slate-900"
      >
        <div class="mx-auto max-w-7xl px-4 py-14 text-center">
          <h1 class="text-slate-900 dark:text-white text-2xl font-bold">
            Contact & Inquiries
          </h1>
          <p
            class="mx-auto mt-3 max-w-xl text-slate-600 dark:text-slate-300 text-base"
          >
            Have a question about a booking, or want help planning a trip? Send
            us a message — our agents typically reply within 24 hours.
          </p>
        </div>
      </section>
      ...
      <section class="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-3">
        <div class="md:col-span-2">
          <div
            class="rounded-lg border border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800"
          >
            <div class="p-6">
              <form @submit.prevent="submit" class="grid gap-4 md:grid-cols-2">
                <div>
                  <label
                    for="cname"
                    class="block text-base font-medium text-slate-900 dark:text-white"
                    >Name</label
                  >
                  <input
                    id="cname"
        ...
        <div class="space-y-4">
          ...
          >
            <div
              class="flex h-10 w-10 items-center justify-center rounded-lg bg-sky-100 dark:bg-sky-900/30 text-sky-600 dark:text-sky-400"
            >
